package com.librarymanagement.common.redisson;

import com.librarymanagement.common.exception.ErrorCode;
import com.librarymanagement.common.exception.LockAcquisitionException;
...
public class RedissonDistributedLockAop {
    ...
    @Around("@annotation(com.librarymanagement.common.redisson.RedissonDistributedLock)")
        ...
        try {
            ...
            if (!available) {
                ...
                throw new LockAcquisitionException(
                        ErrorCode.LOCK_ACQUISITION_EXCEPTION,
                        ErrorCode.LOCK_ACQUISITION_EXCEPTION.getStatusMessage()
                );
            }
